...
class home(TemplateView):
    ...
    def get(self, request):    
        ...
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
 
        context =  {
            'view_Wish' : Wish_view1, 
...
class fullView(TemplateView):
    ...
    def get(self, request, ProductID):  
        user_email = request.user.email 
        Product_view1 = db_Product.objects.filter(db_Product_ID = ProductID).first()
...
class orderProduct(TemplateView):
    ...
    def get(self, request, OrderProdID):
        ...
        Product_view1 = db_Product.objects.filter(db_Product_ID = OrderProdID).first()
        ...
        return render(request, 'orderProduct.html', context | context2) 
    def post(self, request, OrderProdID): 
        ...
        try:
            if db_Place_Order.objects.filter(product_id_order = OrderProdID, email_user = var_user_email).first():
                ...
                order_place.status_order  = var_status_place #(Passed/Pendding/On_way/Cancel/)
...
class view_Product_admin(TemplateView):
    ...
    def post(self, request): 
        context = {}
        return render(request, self.template_name, context | context2)
    ...
    def get(self, request):  
        ...
        return render(request, 'viewProduct.html', context | context2) 
...
class header(TemplateView):
    ...
    def get(self, request): 
        ...
        return render(request, 'header.html', context | context2) 
...
class footer(TemplateView):
    ...
    def get(self, request): 
        user_email = request.user.email 
        MSG_obj1 = db_Message_Admin.objects.filter(db_Message_email = user_email).all()
        context = { 
            'obj_MSG' : MSG_obj1,
        }
        return render(request, 'footer.html', context | context2)
...
class adminBoard(TemplateView):
    ...
    def get(self, request): 
        ...
        return render(request, 'adminBoard.html', context | context2)
...
class setting(TemplateView):
    ...
    def get(self, request):  
        ...
        return render(request, 'setting.html', context | context2)  
...
class messageAdmin(TemplateView):
    ...
    def get(self, request, email):  
        user_email = request.user.email 
        perse_email = email
        Product_view1 = db_Product.objects.filter(db_Product_Category= "Accessories").all()  
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all() 
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = { 
            'view_Product' : Product_view1, 
        ...
        return render(request, 'messageAdmin.html', context | context2)  
...
class wishlist(TemplateView):   
    ...
    def get(self, request): 
        ...
        return render(request, 'wishlist.html', context | context2) 
...
class search(TemplateView):
    ...
    def get(self, request):
        ...
        return render(request, 'search.html', context | context2) 
...
class view_UserByAdmin(TemplateView):
    ...
    def get(self, request):  
        ...
        return render(request, 'viewUser.html', context | context2) 
...
class update_User_byAdmin(TemplateView): 
    ...
    def get(self, request, email):
        ...
        return render(request, 'updateUser.html', context | context2)
...
class mobile_Product_admin(TemplateView):
    ...
    def get(self, request): 
        ...
        return render(request, 'addProduct.html', context | context2)  
...
class update_Mobile_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID):  
        Product_view1 = db_Product.objects.get(db_Product_ID = ProdID) 
        ...
        return render(request, 'updateMobile.html', context | context2)
...
class mobileShow(TemplateView):
    ...
    def get(self, request): 
        Product_view_mobile = db_Product.objects.filter(db_Product_Category= "Mobile").all()  
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()  
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'mobile_view_Product' : Product_view_mobile,  
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'mobileShow.html', context | context2)  
...
class computerShow(TemplateView):
    ...
    def get(self, request): 
        Product_view_computer = db_Product.objects.filter(db_Product_Category= "Computer").all()  
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'computer_view_Product' : Product_view_computer,  
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'computerShow.html', context | context2)  
...
class update_Computer_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID): 
        Product_view1 = db_Product.objects.get(db_Product_ID = ProdID) 
        Computer_view1 = db_Computer.objects.get(db_Computer_ID =  ProdID)
        Image_view1 = db_Product_Image.objects.get(db_Image_ID =  ProdID)
        user_email = request.user.email
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'view_Product' : Product_view1,
            'view_Computer' : Computer_view1, 
            'view_Image': Image_view1,
            'count_Wish' : Wish_count,  
         }
        return render(request, 'UpdateComputer.html', context | context2)
...
class shoesShow(TemplateView):
    ...
    def get(self, request): 
        Product_view_shoes = db_Product.objects.filter(db_Product_Category= "Shoes").all()  
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'shoes_view_Product' : Product_view_shoes, 
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'shoesShow.html', context | context2)  
...
class update_Shoes_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID):  
        ...
        return render(request, 'UpdateShoes.html', context | context2)
...
class clothShow(TemplateView):
    ...
    def get(self, request):  
        Product_view_cloth = db_Product.objects.filter(db_Product_Category= "Cloth").all()  
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all() 
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'cloth_view_Product' : Product_view_cloth, 
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count,  
         }
        return render(request, 'clothShow.html', context | context2)  
...
class update_Cloth_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID): 
        ...
        return render(request, 'UpdateCloth.html', context | context2)
...
class watchShow(TemplateView):
    ...
    def get(self, request):  
        Product_view_watch = db_Product.objects.filter(db_Product_Category= "Watch").all()   
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'watch_view_Product' : Product_view_watch, 
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'watchShow.html', context | context2)  
...
class update_Watch_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID): 
        ...
        return render(request, 'UpdateWatch.html', context | context2)
...
class tvShow(TemplateView):
    ...
    def get(self, request):  
        Product_view_tv = db_Product.objects.filter(db_Product_Category= "Tv").all()  
        user_email = request.user.email
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all()  
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()   
        context = {
            'tv_view_Product' : Product_view_tv, 
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'tvShow.html', context | context2)  
...
class update_Tv_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID):  
        ...
        return render(request, 'UpdateTv.html', context | context2)
...
class accessShow(TemplateView):
    ...
    def get(self, request):  
        Product_view_access = db_Product.objects.filter(db_Product_Category= "Accessories").all() 
        user_email = request.user.email 
        Wish_view1 = db_Wishlist.objects.filter(db_Wishlist_email = user_email).all() 
        Wish_count = db_Wishlist.objects.filter(db_Wishlist_email = user_email).first()
        context = {
            'access_view_Product' : Product_view_access,  
            'view_Wish' : Wish_view1,
            'count_Wish' : Wish_count, 
         }
        return render(request, 'accessShow.html', context | context2)  
...
class update_Access_byAdmin(TemplateView): 
    ...
    def get(self, request, ProdID):  
        ...
        return render(request, 'UpdateAccess.html', context | context2)
